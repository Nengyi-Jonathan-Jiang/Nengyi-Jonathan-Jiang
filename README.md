...
- [**AArch64 Simulator**](https://github.com/Nengyi-Jonathan-Jiang/AArch64-Simulator)  
  ...
  I built this to explore computer architecture concepts like caching, pipelining, and branch prediction while exploring
...
- [**Parser and Lexer Generators**](https://github.com/Nengyi-Jonathan-Jiang/Parser-Lexer-Generators)   
  A canonical LR(1) parser generator and DFA-based lexer generator with linear-time tokenization and parsing.
...
- [**Voxel Rendering Engine**](https://github.com/Nengyi-Jonathan-Jiang/Voxel-Rendering-Engine)  
  ...
  I built this to explore low-level optimizations used in game engine code. It features a custom OpenGL rendering layer,
  GPU-accelerated procedural terrain, dynamic lighting, and ambient occlusion.

---

### Current Work

- Rust/WASM microarchitecture simulation for AArch64 Simulator
